...
//	protected TweenAnimLoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
//		TweenAnimLoadingLayout layout = (TweenAnimLoadingLayout) mLoadingAnimationStyle.createLoadingLayout(context, mode,
//				getPullToRefreshScrollDirection(), attrs);
//		layout.setVisibility(View.INVISIBLE);
//		return layout;
//	}
...
//			}
//		}
		//����ԭʼ�ĵط����½�����layout����TweenAnimLoadingLayout
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
